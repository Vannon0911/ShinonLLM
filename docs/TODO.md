...
## P0 (kritisch)
- [x] Default-Laufpfad auf Runtime -> Orchestrator -> Inference festgezogen (`orchestrateTurn` ruft `routeBackendCall`; Live + Offline-Evaluator ist Pflichtpfad).
...
- [x] Inference auf Live-Pfad + verpflichtenden Offline-Evaluator mit Replay-Hash umgestellt.
