...
function resolveBackendUrl(path) {
    const configuredOrigin = process.env.BACKEND_ORIGIN?.trim() || process.env.NEXT_PUBLIC_BACKEND_ORIGIN?.trim() || DEFAULT_BACKEND_ORIGIN;
...
async function POST(request) {
    ...
    return new __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"](payload, {
